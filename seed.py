...
# Іспити
Exam.objects.create(subject=s1, student=st1,  date=date(2025,12,15), mark=87)
Exam.objects.create(subject=s1, student=st3,  date=date(2025,12,15), mark=74)
Exam.objects.create(subject=s1, student=st4,  date=date(2025,12,15), mark=91)
Exam.objects.create(subject=s1, student=st5,  date=date(2025,12,15), mark=58)
Exam.objects.create(subject=s1, student=st6,  date=date(2025,12,15), mark=82)
Exam.objects.create(subject=s2, student=st2,  date=date(2025,12,20), mark=72)
Exam.objects.create(subject=s2, student=st3,  date=date(2025,12,20), mark=65)
Exam.objects.create(subject=s2, student=st9,  date=date(2025,12,20), mark=88)
Exam.objects.create(subject=s2, student=st10, date=date(2025,12,20), mark=45)
Exam.objects.create(subject=s3, student=st1,  date=date(2025,12,5),  mark=93)
Exam.objects.create(subject=s3, student=st4,  date=date(2025,12,5),  mark=61)
Exam.objects.create(subject=s3, student=st5,  date=date(2025,12,5),  mark=77)
Exam.objects.create(subject=s4, student=st2,  date=date(2025,12,10), mark=84)
Exam.objects.create(subject=s4, student=st6,  date=date(2025,12,10), mark=55)
Exam.objects.create(subject=s4, student=st9,  date=date(2025,12,10), mark=90)
Exam.objects.create(subject=s5, student=st1,  date=date(2025,12,20), mark=70)
Exam.objects.create(subject=s5, student=st3,  date=date(2025,12,20), mark=68)
Exam.objects.create(subject=s5, student=st10, date=date(2025,12,20), mark=52)
